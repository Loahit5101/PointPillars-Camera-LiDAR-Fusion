...
class clocs_data(Dataset):
    ...
    def __init__(self, _2d_path, _3d_path, index_path, input_data, infopath = '../data/clocs_data/info/kitti_infos_trainval.pkl', val = False):
        ...
        for i in range(len(self.anno)):
            ...
            self.id2ind[int(self.anno[i]['image']['image_idx'])] = i
    ...
    def generate_input(self):
        ...
        for i in tqdm(range(len(self.ind))):
            ...
            path=os.path.join('/home/loahit/Downloads/PointPillars-main/results/result_cloc_no_nms/', f'{self.ind[i]}.pkl')
            self._3d_path='/home/loahit/Downloads/PointPillars-main/results/result_cloc_no_nms'
            with open(self._3d_path+"/"+self.ind[i]+".pkl", 'rb') as f:
                  _3d_result = pickle.load(f)
    ...
    def train_stage_2(self, _3d_result,top_predictions):
        ...
        angles = torch.tensor(_3d_result['rotation_y']).reshape(-1,1)

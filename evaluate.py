...
def main(args):
    ...
    #saved_submit_path = os.path.join(saved_path, 'result_val_pickle')
    #saved_submit_path = os.path.join(saved_path, 'result_train_pickle')
    #saved_submit_path = os.path.join(saved_path, 'result_val_no_nms_pickle')
    saved_submit_path = os.path.join(saved_path, 'result_train_no_nms_pickle')
    ...
    with torch.no_grad():
        ...
        for i, data_dict in enumerate(tqdm(train_dataloader)):
            ...
            for j, result in enumerate(batch_results):
                ...
                format_result['frame_id'].append(idx)
                ...
                for lidar_bbox, label, score, bbox2d, camera_bbox in \
                    ...
                    format_result['boxes_lidar'].append(lidar_bbox)
                    
                    
                
                write_pickle(format_result, os.path.join(saved_submit_path, f'{idx:06d}.pkl'))
